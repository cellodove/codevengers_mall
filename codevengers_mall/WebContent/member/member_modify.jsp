...
<body>
    <h1>회원 수정</h1>
    <form action="./MemberChangeModify.do" method="post" name="signupform">
        <table id="jointable">
            <tr>
                <th>아이디</th>
                <td>
                    <input type="text" value="${mem_id}" name="mem_id" id="id" size="12" maxlength="12" />
                </td>
            </tr>
            ...
            <tr>
                <th>비밀번호</th>
                <td>
                    <input type="password" value="${mem_passwd}" name="mem_passwd" id="pwd" size="12" maxlength="12" />
                </td>
            </tr>
            ...
            <tr>
                <th>이름</th>
                <td>
                    <input type="text" value="${mem_name}" name="mem_name" id="name" size="12" maxlength="12" />
                </td>
            </tr>
              ...
              <tr>
                <th>생일</th>
                <td>
                    <input type="text" value="${mem_birth}" name="mem_birth" id="mem_birth" size="8" maxlength="8" />
                </td>
            </tr>
            ...
            <tr>
                <th>전화번호</th>
                <td>
                    <input type="text" value="0${mem_tel1}" name="mem_tel1" id="tel1" size="3"maxlength="3" />- 
                    <input type="text" value="${mem_tel2}" name="mem_tel2" id="tel2"size="4" maxlength="4" />- 
                    <input type="text" value="${mem_tel3}" name="mem_tel3" id="tel3" size="4" maxlength="4" />
                </td>
            </tr>
            ...
            <tr>
                <th>우편번호</th>
                <td>
                    <input type="text" value="${mem_zipcode}" name="mem_zipcode" id="mem_zipcode" size="12" maxlength="12" />
                </td>
            </tr>
            ...
            <tr>
                <th>주소<br>상세주소</th>
                <td>
                    <input type="text" value="${mem_address1}" name="mem_address1" id="mem_address1" size="50" maxlength="05" /><pre></pre>
                    <input type="text" value="${mem_address2}" name="mem_address2" id="mem_address2" size="50" maxlength="50" />
                </td>
            </tr>
            ...
            <tr>
                <th>이메일</th>
                <td>
                    <input type="text" value="${mem_email}" name="mem_email" id="email" size="50"maxlength="50" />
