...
public class MemberVO {
	...
	public int getMem_email_ck() {
		return mem_email_ck;
	}

	public void setMem_email_ck(int mem_email_ck) {
	...
	public int getMem_manager() {
		return mem_manager;
	}

	public void setMem_manager(int mem_manager) {
